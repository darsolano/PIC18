...
/**********************************************************************
* Function:        int RingBuffer_Init(RINGBUFF_T *RingBuff, void *buffer, int itemSize, int count)
* PreCondition:    None
* Input:		   pin direction as INPUT or OUTPUT
* Output:		   None
* Overview:		   Init ring buffer using data structure + a defined buffer as an array of strings
* 					count will be the
***********************************************************************/
